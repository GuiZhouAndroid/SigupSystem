...
public class Title1Activity extends MySwipeBackActivity implements View.OnClickListener {
    private FloatingActionButton fab_title1;
    private Toolbar toolbar_title;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ency_title1);
        initView();//初始化View
    ...
    private void initView() {
        ...
        //悬浮按钮
        fab_title1= (FloatingActionButton) findViewById(R.id.fab_title1);
        fab_title1.setOnClickListener(this);
    ...
    /**
     * Toolbar 的Navigation Button 添加点击事件,用于finish当前Activity，返回上一次未finish的Activity
     * @param item
     * @return
     */
    @Override
