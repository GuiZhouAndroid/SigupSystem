...
public class Title3Acitvity extends MySwipeBackActivity implements View.OnClickListener {
    private Toolbar toolbar_title;
    private FloatingActionButton fab_title3;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ency_title3);
        initView();//初始化View
    ...
    private void initView() {
        ...
        //悬浮按钮
        fab_title3= (FloatingActionButton) findViewById(R.id.fab_title3);
        fab_title3.setOnClickListener(this);
