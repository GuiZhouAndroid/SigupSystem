...
public class Title4Acitvity extends MySwipeBackActivity implements View.OnClickListener {
    private Toolbar toolbar_title;
    private FloatingActionButton fab_title4;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ency_title4);
        initView();//初始化View
    ...
    private void initView() {
        ...
        //悬浮按钮
        fab_title4= (FloatingActionButton) findViewById(R.id.fab_title4);
        fab_title4.setOnClickListener(this);
