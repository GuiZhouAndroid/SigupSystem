package com.zhangsong.com.signup_system.navigation;
...
import com.zhangsong.com.signup_system.adapter.Navigation.NavigationViewPagerAdapter;
import com.zhangsong.com.signup_system.navigation.View.CustomViewPager;
...
public class EasyNavigitionBar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, R.layout.navigation_container, null);
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    private void setViewPagerAdapter() {
        adapter = new NavigationViewPagerAdapter(fragmentManager, fragmentList);
