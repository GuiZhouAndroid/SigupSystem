package com.zhangsong.com.signup_system.utils.RegularExpression;
...
public class Validator {
    ...
    /**
     * 正则表达式：验证密码_强密码(必须包含大小写字母和数字的组合，不能使用特殊字符，长度在 8-10 之间)
     */
    public static final String REGEX_PASSWORD = "^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9]{8,10}$";
