package com.zhangsong.com.signup_system.utils.ui.Dialogs;
...
public class DialogPromptPermission extends Dialog {
    ...
    protected DialogPromptPermission(@NonNull Context context, boolean cancelable, @Nullable DialogInterface.OnCancelListener cancelListener) {
