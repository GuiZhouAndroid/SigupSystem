package com.zhangsong.com.signup_system.view;
...
public class ProcessSuccessView extends View {
    /**
     * 默认线宽度
     */
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ProcessSuccessView, defStyleAttr, 0);
        texts = a.hasValue(R.styleable.ProcessSuccessView_texts) ?
                getResources().getStringArray(a.getResourceId(R.styleable.ProcessSuccessView_texts, 0)) : texts;
        mLineWidth = a.hasValue(R.styleable.ProcessSuccessView_sign_line_width) ?
                a.getDimensionPixelSize(R.styleable.ProcessSuccessView_sign_line_width, 0) : mLineWidth;
        mThumbRadius = a.hasValue(R.styleable.ProcessSuccessView_sign_thumb_radius) ?
                a.getDimensionPixelSize(R.styleable.ProcessSuccessView_sign_thumb_radius, 0) : mThumbRadius;
        mTextSize = a.hasValue(R.styleable.ProcessSuccessView_sign_textsize) ?
                a.getDimensionPixelSize(R.styleable.ProcessSuccessView_sign_text_color, 0) : mTextSize;
        mReachedColor=a.hasValue(R.styleable.ProcessSuccessView_sign_color_reached)?
                a.getColor(R.styleable.ProcessSuccessView_sign_color_reached,D_REACH_COLOR):D_REACH_COLOR;
        mUnreachedColor=a.hasValue(R.styleable.ProcessSuccessView_sign_color_unreached)?
                a.getColor(R.styleable.ProcessSuccessView_sign_color_unreached,D_UNREACH_COLOR):D_UNREACH_COLOR;
        mTextColor=a.hasValue(R.styleable.ProcessSuccessView_sign_text_color)?
                a.getColor(R.styleable.ProcessSuccessView_sign_text_color,D_TEXT_COLOR):D_TEXT_COLOR;
        a.recycle();
    }
